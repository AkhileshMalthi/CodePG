...
class Config:
    ...
    def __init__(self, config_path: str | None = None):
        ...
        Parameters:
            config_path (str | None): Path to the configuration file. If None, uses default locations.
        """
    ...
    def base_dir(self) -> str:
        ...
        return str(self._config.get("base_dir", DEFAULT_CONFIG["base_dir"]))

    @property
    def editor_command(self) -> str:
        """Get the command to open the editor."""
        return str(self._config.get("editor_command", DEFAULT_CONFIG["editor_command"]))
    ...
    def save(self, path: Path | None = None) -> tuple[bool, str]:
        """
        Save the current configuration to a file.

        Parameters:
            path (Path | None): Path to save the configuration to.
    ...
    @classmethod
    def create_default_config(cls, path: Path | None = None) -> tuple[bool, str]:
        """
        Create a default configuration file.

        Parameters:
            path (Path | None): Path to create the configuration file.
